...
const Hero = ({ data }: any) => {
  return (
    <div
      id="home"
      className="scroll-mt-[80px] px-5 pt-3 pb-5 lg:py-16 lg:px-10 xl:px-24 text-slate-800 p-6  mx-auto md:flex flex-wrap flex-1 justify-between items-center overflow-hidden"
    >
      ...
      <div className="md:w-2/5 flex flex-col translate-x-[100vw] animate-reveal-to-left animation-delay-1000">
        <h1 className="text-4xl md:text-4xl lg:text-5xl flex items-end font-bold py-6">
          ...
          >
            ...
            <SwiperSlide>
              <Typescript className="h-full w-full" />
            </SwiperSlide>
            <SwiperSlide>
            ...
            <SwiperSlide>
              <Wordpress className="h-full w-full" />
            </SwiperSlide>
            <SwiperSlide>
              <Prestashop className="h-full w-full" />
            </SwiperSlide>
          </Swiper>
